...
class AuthRequest(object):
    ...
    def __init__(self, username=None, password=None, google_access_token=None, expire_after_seconds=300, service_grants=None, local_vars_configuration=None):  # noqa: E501
    ...
    def expire_after_seconds(self):
        ...
        Optional integer specifying the number of seconds that the returned token should be valid for.   # noqa: E501
