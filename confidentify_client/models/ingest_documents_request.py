...
class IngestDocumentsRequest(object):
    ...
    def record_source(self):
        ...
        Defines a string which identifies the source of any records in the documents. This could be the name of the originating document store or system.   # noqa: E501
