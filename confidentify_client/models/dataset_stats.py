...
class DatasetStats(object):
    ...
    def __init__(self, files_received=None, files_processed=None, documents_received=None, documents_processed=None, records_inserted=None, records_indexed=None, records_per_source=None, local_vars_configuration=None):  # noqa: E501
        ...
        if records_per_source is not None:
    ...
    def records_per_source(self):
        """Gets the records_per_source of this DatasetStats.  # noqa: E501


        :return: The records_per_source of this DatasetStats.  # noqa: E501
        :rtype: dict(str, int)
        """
        return self._records_per_source

    @records_per_source.setter
    def records_per_source(self, records_per_source):
        """Sets the records_per_source of this DatasetStats.


        :param records_per_source: The records_per_source of this DatasetStats.  # noqa: E501
        :type: dict(str, int)
        """

        self._records_per_source = records_per_source
