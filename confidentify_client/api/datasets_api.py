...
class DatasetsApi(object):
    ...
    def dataset_by_id_post(self, dataset_id, **kwargs):  # noqa: E501
        """Update dataset  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.dataset_by_id_post(dataset_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str dataset_id: (required)
        :param DatasetUpdateRequest dataset_update_request:
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.dataset_by_id_post_with_http_info(dataset_id, **kwargs)  # noqa: E501

    def dataset_by_id_post_with_http_info(self, dataset_id, **kwargs):  # noqa: E501
        """Update dataset  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.dataset_by_id_post_with_http_info(dataset_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['dataset_id', 'dataset_update_request']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method dataset_by_id_post" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'dataset_id' is set
        if self.api_client.client_side_validation and ('dataset_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['dataset_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `dataset_id` when calling `dataset_by_id_post`")  # noqa: E501
        ...
        body_params = None
        if 'dataset_update_request' in local_var_params:
            body_params = local_var_params['dataset_update_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def records_get(self, dataset_id, **kwargs):  # noqa: E501
        ...
        :param str filter_ids: A comma-separated list (max 50 items) of IDs to fetch. Using this parameter will disable result paging, so `page[after]` and `page[size]` will have no effect.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def records_get_with_http_info(self, dataset_id, **kwargs):  # noqa: E501
        ...
        all_params = ['dataset_id', 'page_size', 'page_after', 'filter_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'filter_ids' in local_var_params and local_var_params['filter_ids'] is not None:  # noqa: E501
            query_params.append(('filter_ids', local_var_params['filter_ids']))  # noqa: E501
